...
<div class="container">
    ...
    <div class="terminal">
        <p class="prompt">ERROR 404 PAGE NOT FOUND. The page you requested cannot be found right meow. Maybe your bookmark for script is wrong?? Try typing 'kittens'.</p>
